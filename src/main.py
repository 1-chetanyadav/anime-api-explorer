...
def main():
    ...
    while True:
        ...
        if choice == '1':   
            ...
            if results:
                for anime in results['data']:
                    ...
                    anime_details = {anime['mal_id']: anime['title']}
                    print("\n")
            ...
            if score1 > score2:
                ...
                anime_details = f"{title1} has a higher score than {title2}."
            elif score1 < score2:
                print(f"{title2} has a higher score than {title1}.")
                anime_details = f"{title2} has a higher score than {title1}."
            else:
                    print(f"{title1} and {title2} have the same score.")
                    anime_details = f"{title1} and {title2} have the same score."
            print("\n")
        ...
        save_choice = input("Do you want to save the details to a file? (yes/no): ")
        if save_choice.lower() == 'yes':
        
            filename = save_anime_details_to_file(anime_details)
            print(f"Details saved to {filename}", "\n")
        else:
            print("No details to save for this action.", "\n")
